...
export default function StolenMenueList({number, nationalID, carID, carType, img, color, manufacturering_year, license_create_date, license_expired_date, vehicle_class ,passage_unit,render}) {
      const [ShowRemainData,setShowData]= useState(0)
    return (
        <div className='allRow'>
        {ShowRemainData === 1 ? <StolenCarCard
          exit={setShowData}
          number={number}
